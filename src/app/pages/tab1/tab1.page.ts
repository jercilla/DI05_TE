...
export class Tab1Page implements OnInit {
  ...
  generarPDF() {
     ...
     */
    const sections = this.container.nativeElement.querySelectorAll(
      '.seccion'
  ...
  addHeader(doc: jsPDF) {
    ...
    doc.rect(5, 5, doc.internal.pageSize.width - 5, 45, 'F');
  ...
  addFooter(doc: jsPDF, pag: number) {
    doc.setFillColor('#CCCCCC');
    doc.rect(
      10,
    ...
    doc.text(
      `Página ${pag} de ${doc.getNumberOfPages()}`,
